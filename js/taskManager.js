        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p class="card-text mt-2">${description}</p>
                    <div class="d-flex flex-wrap justify-content-between border border-danger">
                        <div>
                            <select class="form-control btn-outline-secondary border border-primary" id="${id}" onchange="changeStatus(${id})">
                        ...
                        <div>
                            <button type="button" class="btn btn-default btn-outline-secondary border border-success" id="${id}" onclick="deleteTask(${id})">Delete</button>
                        </div>
                    </div>
            </div>
        </div>
